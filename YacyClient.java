...
/**
 *  ADAPTED FROM YacySearchClient.java YaCySearchClient (an interface for Adaptive Replacement Caches)
 ...
 * 
 * https://github.com/niitsuma/YaCyAPIClient/blob/master/YaCyAPIClient.java
 * @author me
 */
public class YacyClient {
    ...
    public YacyClient(final String host, final int port) {
        this.host = host;
        this.port = port;
    }
    
    public YacySearch search(String query) {
        return new YacySearch(query);
    }
    ...
    public class YacySearch {
        ...
        protected YacySearch(String query) {
            this.offset = -10;
            this.query = query;
        }
        ...
        public SearchResult next() throws IOException {
            ...
            return new SearchResult(query, offset);
        }
        ...
        public class SearchResult extends ArrayList<RSSEntry> {
            ...
            public SearchResult(String query, int offset) throws IOException {
                URL url;
                Document doc;
                String u = new StringBuilder(120).append("http://")
                        ...
                        //.append(CommonPattern.SPACE.matcher(YaCySearchClient.this.query).replaceAll("+"))
